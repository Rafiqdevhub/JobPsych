      ...
      <div className="px-6 py-4 bg-gray-50">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="flex-1 bg-gray-300 text-gray-700 py-3 px-4 rounded-md font-medium hover:bg-gray-400 disabled:opacity-50 transition-colors"
          >
            Cancel
          </button>
          ...
          <button
            ...
            className="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-md font-medium hover:bg-indigo-700 disabled:opacity-50 transition-colors flex items-center justify-center"
          >
            {isProcessing ? (
              <>
                <svg
