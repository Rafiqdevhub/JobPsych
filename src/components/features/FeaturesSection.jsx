    ...
    >
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-16">
          ...
          <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-purple-200 hover:-translate-y-1">
            <div className="absolute inset-0 bg-purple-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <div className="text-center bg-indigo-600 rounded-3xl p-6 sm:p-12 text-white">
          ...
          <div className="mb-8 max-w-4xl mx-auto text-lg text-white/90 text-center">
            ...
            <p className="mt-2">
              ...
              <span className="text-purple-200 font-bold">ATS Analyzer</span> to
